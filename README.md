...
My own software engineer public profile website. A little bit about me. I usually worked as a Web Developer in Brazil for this first 10 years of software engineering (2009-2019), but for now I'm researching more about other areas (Mobile Development and Data Science) and working abroad as a Software Engineer since 2020. I'm currently building **Open Source Platforms** around **Social Networking**, **Content Systems**, **Django Backends**, **AI Experiments**, and **Game Development**. 

For more information, check out my [portfolio](https://williamlagos.github.io/). Feel free to contact me by [email](mailto:william.lagos@icloud.com).

## Now (current focus)
- **Atria**: decentralized social marketplace / social network experiments *(active)*
- **Contents**: headless CMS + content APIs *(active)*
- **Django packages**: reusable backend apps (shipping, delivery, events, etc.) *(active)*
- **EOS**: Docker + scripts + Linux tooling as a supporting infrastructure platform *(active)*
- **Experiments**: artificial intelligence experiments *(active)*
- **Elements**: game engine experiments *(active / rebooting)*
- **Coding**: challenges & small experiments *(active)*

---

## Social / Federated Network Experiments
- [atria](https://github.com/williamlagos/atria) — Decentralized Social Commerce (ActivityPub + marketplace experiments)

## Headless CMS / Websites
- [contents](https://github.com/williamlagos/contents) — Headless CMS with e-commerce capabilities *(active)*
- [contents-api](https://github.com/williamlagos/contents-api) — Headless Content Management API in Python *(active / merge candidate with `contents`)*
